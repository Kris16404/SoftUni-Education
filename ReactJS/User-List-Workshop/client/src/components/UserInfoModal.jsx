import { formatDate } from '../utils/isoFormater.js';
        ...
        <div className="detail-container">
          ...
          <div className="content">
            <div className="image-container">
              <img
                src={props.imageUrl}
                alt={`${props.firstName}'s image`}
                className="image"
              />
            </div>
            <div className="user-details">
              <p>
                User Id: <strong>{props._id}</strong>
              </p>
              <p>
                Full Name:
              ...
              <p>
                Address:
                <strong>
                  {`${props.address.country} ${props.address.city} ${props.address.street} ${props.address.streetNumber}`}
                </strong>
              </p>
