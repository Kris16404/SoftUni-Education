...
describe('E2E tests', function () {
  ...
  describe('Navigation bar [ 5 Points ]', () => {
    ...
    it('Guest user should see correct navigation [ 2.5 Points ]', async () => {
      ...
      expect(await page.isVisible('nav >> text=Add Event'), 'Create is visible')
        .to.be.false;
  ...
  describe('Home Page [ 10 Points ]', () => {
    it('Show home page [ 5 Points ]', async () => {
      ...
      expect(
        await page.isVisible(
          'text=Welcome to our community-driven events website! We believe that the best events come from the community.'
        )
      ).to.be.true;
    });
    ...
    it('Show home page [ 5 Points ]', async () => {
      ...
      expect(
        await page.isVisible(
          'text=So why wait? Join our community today and start discovering and sharing the best events in your area!'
        )
      ).to.be.true;
    });
  });
  ...
  describe('CRUD [ 50 Points ]', () => {
    ...
    it('Check details information [ 5 Points ]', async () => {
      ...
      const date = await page.$$eval('#details-wrapper p #date', (t) =>
        t.map((s) => s.textContent)
      );
  ...
  describe('BONUS : Going functionality  [ 15 Points ]', async () => {
    ...
    it('Going button should be hidden(not visible) after a click on it [ 2.5 Points ]', async () => {
      ...
      const [request] = await Promise.all([onRequest, page.click('#go-btn')]);
    ...
    it('Going button should increase total buys by 1 after a click on it [ 5 Points ]', async () => {
      ...
      let goings = await page.$$eval('#go', (t) => t.map((s) => s.textContent));
      ...
      goings = await page.$$eval('#go', (t) => t.map((s) => s.textContent));
