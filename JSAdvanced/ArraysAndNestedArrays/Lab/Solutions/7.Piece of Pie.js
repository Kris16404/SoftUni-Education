function pieceOfPie(arrOfPies, startPie, endPie) {
    const startIndex = arrOfPies.indexOf(startPie);
    const endIndex = arrOfPies.indexOf(endPie);
    const cuttedArr = arrOfPies.slice(startIndex, endIndex + 1)
